import { n as typescriptDefaults } from "./register-CUuvP5KT.js";
import { a as MarkerSeverity, c as Range, f as Uri, m as languages, o as MarkerTag, p as editor } from "./editor.api-B1zUMWqV.js";
import { t as createWebWorker } from "./workers-Bt8yImXP.js";
	...
	_getClient() {
		if (!this._client) this._client = (async () => {
			this._worker = createWebWorker({
				...
				createWorker: () => new Worker(new URL("../../monaco-editor/esm/vs/languages/features/typescript/ts.worker.js", import.meta.url), { type: "module" }),
				label: this._modeId,
				keepIdleModels: true,
				createData: {
...
//#endregion
//#region node_modules/monaco-editor/esm/vs/languages/features/typescript/lib/lib.index.js
var libFileSet = {};
...
var SignatureHelpAdapter = class SignatureHelpAdapter extends Adapter {
	...
	static _toSignatureHelpTriggerReason(context) {
		switch (context.triggerKind) {
			case languages.SignatureHelpTriggerKind.TriggerCharacter: if (context.triggerCharacter) {
...
//#endregion
//#region node_modules/monaco-editor/esm/vs/languages/features/typescript/tsMode.js
