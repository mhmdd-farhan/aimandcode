import { m as languages, p as editor } from "./editor.api-B1zUMWqV.js";
	...
	_getClient() {
		...
		if (!this._client) {
			this._worker = createWebWorker({
				...
				createWorker: () => new Worker(new URL("../../monaco-editor/esm/vs/languages/features/json/json.worker.js", import.meta.url), { type: "module" }),
	...
	while (true) {
		...
		switch (kind) {
			case 12:
				...
				break;
			case 13: type = TOKEN_COMMENT_BLOCK;
		}
